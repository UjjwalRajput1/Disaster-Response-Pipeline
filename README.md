...
### Dependencies
* Python 3.5+
* Machine Learning Libraries: NumPy, SciPy, Sckit-Learn ,Pandas 
...
```
https://github.com/UjjwalRajput1/Disaster-Response-Pipeline.git
```
<a name="execution"></a>
### Executing Program:
...
* [Ujjwal Rajput] (https://github.com/UjjwalRajput1/Disaster-Response-Pipeline)
